...
Java_uk_lgl_modmenu_FloatingModMenuService_setTitleText(JNIEnv *env, jobject thiz, jobject obj) {
    setText(env, obj, OBFUSCATE("<b>SchoolBoy Runaway 1.03</b>"));
...
Java_uk_lgl_modmenu_FloatingModMenuService_settingsList(JNIEnv *env, jobject activityObject) {
    ...
    const char *features[] = {
            ...
            "-2000_Toggle_True_Sounds",
            "-6_Button_<font color='red'>Close settings</font>",
            "ButtonLink_ Youtube.com/@saveeditoronlinecom _https://youtube.com/@saveeditoronlinecom",
    };
